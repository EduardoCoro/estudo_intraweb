...
uses UserSessionUnit, ServerController, IWTypes;
...
begin
  ...
  begin
    ...
    begin
      ...
      TIWButton(aCell.Control).CSS := 'btn btn-primary';
      TIWButton(aCell.Control).StyleRenderOptions.RenderFlags :=
         [rfRenderZIndex, rfRenderVisibility, rfRenderStatus, rfUseDisplay];
    end;
