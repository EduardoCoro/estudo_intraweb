inherited frmAdminProdutos: TfrmAdminProdutos
  ...
  inherited rgPanel: TIWRegion
    inherited irBarraTopo: TIWRegion
      inherited lblTituloJanela: TIWLabel
        Width = 168
        Caption = 'Administra'#231#227'o de Produtos'
        ExplicitWidth = 168
      end
      ...
      object btnNovoProduto: TIWGradButton
        Left = 15
        Top = 51
        Width = 140
        Height = 36
        Hint = 'Crie um novo Produto'
        Style.Border.Color = clWebGRAY
        Style.Border.Width = 1
        Style.BorderDisabled.Color = clWebGRAY
        Style.BorderDisabled.Width = 1
        ...
        Font.Size = 10
        Font.Style = []
        FriendlyName = 'btnNovoProduto'
        TabOrder = 1
        OnClick = btnNovoProdutoClick
      end
      object btnAlterarProduto: TIWGradButton
        Left = 161
        Top = 51
        Width = 140
        Height = 36
        Hint = 'Altere os dados do Produto selecionado'
        Style.Border.Color = clWebGRAY
        Style.Border.Width = 1
        Style.BorderDisabled.Color = clWebGRAY
        Style.BorderDisabled.Width = 1
      ...
      object btnUploadRelease: TIWGradButton
        Left = 307
        Top = 51
        Width = 150
        Height = 36
        Hint = 'Fa'#231'a upload de um novo arquivo do Produto selecionado'
        Style.Border.Color = clWebGRAY
        Style.Border.Width = 1
        Style.BorderDisabled.Color = clWebGRAY
        Style.BorderDisabled.Width = 1
      ...
      object btnListaReleases: TIWGradButton
        Left = 463
        Top = 51
        Width = 150
        Height = 36
        Hint = 'Liste todos os releases do Produto selecionado'
        Style.Border.Color = clWebGRAY
        Style.Border.Width = 1
        Style.BorderDisabled.Color = clWebGRAY
        Style.BorderDisabled.Width = 1
      ...
      object btnListaProdutos: TIWGradButton
        Left = 619
        Top = 51
        Width = 150
        Height = 36
